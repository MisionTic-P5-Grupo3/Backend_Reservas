...
class Plan_usuario(models.Model): 
    ...
    url                = models.CharField('Url del plan', max_length=2083, default="https://elcomercio.pe/resizer/TGCsuHf4e88fBOhhEUbfaHgHs9A=/560x0/smart/filters:format(jpeg):quality(75)/cloudfront-us-east-1.images.arcpublishing.com/elcomercio/ZPAAAE7JYRBETISIFG3E77ZACU.png")
